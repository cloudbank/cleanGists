 ...
 */
package com.teahouse.gists.repository;

import static com.teahouse.gists.util.ApiUtil.successCall;
...
import com.teahouse.gists.AppExecutors;
import com.teahouse.gists.api.ApiResponse;
import com.teahouse.gists.api.GithubService;
import com.teahouse.gists.db.GistDao;
import com.teahouse.gists.resource.Resource;
import com.teahouse.gists.util.CountingAppExecutors;
import com.teahouse.gists.util.InstantAppExecutors;
...
public class GistFetcherTest {
  ...
  public void init() {
    ...
    LiveData<ApiResponse<List<Gist>>> call = successCall(gists);
  ...
  public void fetchOnChangedStaleFromNetwork() {
    ...
    verify(observer, times(3)).onChanged(isA(Resource.class));

  }

  @Test
  public void fetchOnChangedStaleFromDb() {
    Observer<Resource<List<Gist>>> observer = Mockito.mock(Observer.class);
    dataFetcher.asLiveData().observeForever(observer);
