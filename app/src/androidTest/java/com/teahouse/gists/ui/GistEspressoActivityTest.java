...
import com.teahouse.gists.util.RecyclerViewMatcher;
...
public class GistEspressoActivityTest {
  @Rule  //@todo when/how to use this for real vs fake
  public ActivityTestRule<GistActivity> activityRule = new ActivityTestRule<>(GistActivity.class, false, true);
